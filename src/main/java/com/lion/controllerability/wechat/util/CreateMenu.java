...
public class CreateMenu {
	...
	public static void main(String[] args) {
		...
		//第一个一级菜单
		btn.getButton().add(new ViewButton("水费", "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx1b075537c82c1bca&redirect_uri=http://www.bichi.mobi/wechat/GetUserInfo&response_type=code&scope=snsapi_userinfo#wechat_redirect"));
		//转为json9
